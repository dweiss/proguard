...
public class ConfigurationParser implements AutoCloseable {
    ...
    public void parse(Configuration configuration, BiConsumer<String, String> unknownOptionHandler)
        ...
        while (nextWord != null) {
            ...
            if (ConfigurationConstants.AT_DIRECTIVE.startsWith(nextWord) ||
            ...
            else if (ConfigurationConstants.DONT_COMPRESS_OPTION.startsWith(nextWord))
            ...
            else if (ConfigurationConstants.ZIP_ALIGN_OPTION.startsWith(nextWord))
            ...
            else if (ConfigurationConstants.RENAME_PACKAGE_OPTION.startsWith(nextWord))
                configuration.renamePackages = parsePackageRenameRule(configuration.renamePackages);
            ...
            else if (ConfigurationConstants.KEEP_CODE_OPTION.startsWith(nextWord))
            ...
            else if (ConfigurationConstants.ASSUME_VALUES_OPTION.startsWith(nextWord))
                ...
                configuration.flattenPackageHierarchy = ClassUtil.internalClassName(parseOptionalArgument());
                     ...
                     ConfigurationConstants.DEFAULT_PACKAGE_OPTION.startsWith(nextWord))
            ...
            else if (ConfigurationConstants.DONT_PROCESS_KOTLIN_METADATA.startsWith(nextWord))
                configuration.dontProcessKotlinMetadata = parseNoArgument(true);
            else if (ConfigurationConstants.KEEP_KOTLIN_METADATA.startsWith(nextWord))
                configuration.keepKotlinMetadata = parseKeepKotlinMetadata();
            ...
            else if (ConfigurationConstants.KEY_STORE_OPTION.startsWith(nextWord))
                configuration.keyStores = parseFiles(configuration.keyStores);
            else if (ConfigurationConstants.KEY_STORE_PASSWORD_OPTION.startsWith(nextWord))
            ...
            else if (ConfigurationConstants.KEY_ALIAS_OPTION.startsWith(nextWord))
            ...
            else if (ConfigurationConstants.KEY_PASSWORD_OPTION.startsWith(nextWord))
            ...
            else if (ConfigurationConstants.OPTIMIZE_AGGRESSIVELY.startsWith(nextWord))
                configuration.optimizeConservatively = parseNoArgument(false);
            else if (ConfigurationConstants.ALWAYS_INLINE.startsWith(nextWord))
                parseUnsupportedR8Rules(ConfigurationConstants.ALWAYS_INLINE, true);
            else if (ConfigurationConstants.IDENTIFIER_NAME_STRING.startsWith(nextWord))
                parseUnsupportedR8Rules(ConfigurationConstants.IDENTIFIER_NAME_STRING, true);
            else if (ConfigurationConstants.MAXIMUM_REMOVED_ANDROID_LOG_LEVEL.equals(nextWord))
                parseMaximumRemovedAndroidLogLevel();
            else {
    ...
    private List<PackageRenameRule> parsePackageRenameRule(List<PackageRenameRule> list) throws IOException, ParseException {
        ...
        if (pair.length != 2) {
            throw new ParseException("Expected a package-pattern=>replacement regexp rule syntax: " + nextWord);
        }

        Pattern pattern = Pattern.compile(pair[0]);
        String replacement = pair[1];
        list.add(new PackageRenameRule(pattern, replacement));
    ...
    private List parseIfCondition(List keepClassSpecifications)
        ...
        if (ConfigurationConstants.KEEP_OPTION.startsWith(nextWord))
            keepClassSpecifications = parseKeepClassSpecificationArguments(keepClassSpecifications, true, true, false, false, false, condition);
        else if (ConfigurationConstants.KEEP_CLASS_MEMBERS_OPTION.startsWith(nextWord))
            keepClassSpecifications = parseKeepClassSpecificationArguments(keepClassSpecifications, false, true, false, false, false, condition);
        else if (ConfigurationConstants.KEEP_CLASSES_WITH_MEMBERS_OPTION.startsWith(nextWord))
            keepClassSpecifications = parseKeepClassSpecificationArguments(keepClassSpecifications, false, true, false, true, false, condition);
        else if (ConfigurationConstants.KEEP_NAMES_OPTION.startsWith(nextWord))
            keepClassSpecifications = parseKeepClassSpecificationArguments(keepClassSpecifications, true, true, false, false, true, condition);
        else if (ConfigurationConstants.KEEP_CLASS_MEMBER_NAMES_OPTION.startsWith(nextWord))
            keepClassSpecifications = parseKeepClassSpecificationArguments(keepClassSpecifications, false, true, false, false, true, condition);
        else if (ConfigurationConstants.KEEP_CLASSES_WITH_MEMBER_NAMES_OPTION.startsWith(nextWord))
            keepClassSpecifications = parseKeepClassSpecificationArguments(keepClassSpecifications, false, true, false, true, true, condition);
        else if (ConfigurationConstants.KEEP_CODE_OPTION.startsWith(nextWord))
            keepClassSpecifications = parseKeepClassSpecificationArguments(keepClassSpecifications, false, false, true, false, false, condition);
        else {
            throw new ParseException("Expecting '-keep' option after '-if' option, before " + reader.locationDescription());
        }
